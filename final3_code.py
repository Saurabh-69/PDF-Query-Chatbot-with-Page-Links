# THIS CODE FINDS THE MATCHED TEXT, RELEVANT PAGE NUMBER AND PDF LINK AND BUTTON TO OPEN THE PDF PAGE 
...
def chatbot(query):
    if not text_data:
        raise ValueError("PDF text data has not been initialized.")
